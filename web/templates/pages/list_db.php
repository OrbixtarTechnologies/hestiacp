	...
	<div class="toolbar-inner">
		<div class="toolbar-buttons">
			<?php if ($read_only !== "true") { ?>
				...
				<?php } ?>
				<?php if (ipUsed()) { ?>
					<a target="_blank" href="https://github.com/OrbixtarTechnologies/orbixtar-panel/blob/main/docs/docs/server-administration/databases.md#why-i-can-t-use-http-ip-phpmyadmin">
