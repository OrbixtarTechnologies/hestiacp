					...
					<?php if ($_SESSION["WEB_SYSTEM"] == "nginx") { ?>
						<div class="form-check u-mb10">
							...
							<label for="v_nginx_cache_check">
								...
								<a href="https://github.com/OrbixtarTechnologies/orbixtar-panel/blob/main/docs/docs/server-administration/web-templates.md#nginx-fastcgi-cache" target="_blank" class="u-ml5">
