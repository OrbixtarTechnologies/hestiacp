...
With the introduction of OrbixPanel v1.4.0 we have added certain security features, including the possibility to limit login to certain IP addresses. If your IP address changes, you will not able to login anymore. To disable this feature, run the following commands:
...
No, you cannot. When you update OrbixPanel, the crontab will simply get overwritten. The changes will not get saved in backups either.
...
xxxxxx is the date/time the backup is made during the last update of OrbixPanel
