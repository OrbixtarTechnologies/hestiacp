...
- **default-nomail**: Standard DNS template. Suitable for most usecases when you don’t want to host mail on OrbixPanel.
...
This date is not used by OrbixPanel, but can be used as a reminder.
